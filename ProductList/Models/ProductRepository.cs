...
namespace ProductList.Models
{
    ...
    {
        // 1. Return a list of 3 unique suppliers
        ...
        // 2. Return 9 categories assigned to suppliers without overlap (3 each)
        ...
        // 3. Return 16 products linked to the 9 categories with no overlap
        public static List<Product> GetProducts()
        {
            return new List<Product>
            {
                ...
                new Product { Id = 8, Name = "Product 8", CategoryId = 5 },
                new Product { Id = 9, Name = "Product 9", CategoryId = 5 },
                new Product { Id = 10, Name = "Product 10", CategoryId = 6 },

                new Product { Id = 11, Name = "Product 11", CategoryId = 7 },
